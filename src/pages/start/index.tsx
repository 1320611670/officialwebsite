  ...
  render() {
    return (
      <div className="combined-wrapper">
        ...
        <Link to="/home.html" className="Modal bubble" onClick={()=>{
          
        }}>
            <div className="d lt"></div>
            <div className="d lb"></div>
            <div className="d rt"></div>
            <div className="d rb"></div>
            <p className="text" ></p>
            <span className="save">立即进入</span>
